...
class Customizer_Import_Export {
	...
	public function enqueue_customizer_scripts() {
		wp_enqueue_style( 'templify-importer-import-export', TEMPLIFY_IMPORT_TEMPLATES_URL . 'assets/css/starter-import-export.css', array( 'wp-components' ), TEMPLIFY_IMPORT_TEMPLATES_VERSION );
