...
=======
			...
			<input type="button" class="button templify-importer-import kadence-starter-button" name="templify-importer-import-button" value="<?php esc_attr_e( 'Import', 'kadence' ); ?>" />
